...
export const productDetails: Product[] = [
  {
    ...
    benefits: [
      "Vitality – Treasures daily energy balance and combats fatigue.",
      "Heart Health – Maintains healthy cholesterol and supports circulation.",
      "Diabetes & Metabolism – Supports blood sugar regulation and metabolic health.",
      "Skin & Beauty – Restores softness, protects against dryness, and adds a natural glow.",
    ],
  ...
  },
  {
    ...
    benefits: [
      "Skin Health – Maintains a youthful and vibrant appearance.",
      "Immune Support – Strengthens the body's natural defense system.",
      "Cardiovascular Health – Supports heart function and vascular wellness.",
      "Healing Properties – Assists the body in recovery and tissue repair.",
      "Antimicrobial Action – Possesses natural antibacterial and antifungal properties.",
      "Blood Health – Helps restore and maintain proper iron balance.",
      "Cholesterol Control – Works to effectively reduce bad cholesterol levels.",
    ],
    ...
    specifications: {
      ...
      shelf_life: "12-24 months",
      storage:
        "Store in refrigerator after opening to maintain freshness and prevent rancidity & Keep in a cool, dark place before opening to preserve quality and extend shelf life",
    },
  },
  {
    name: "Walnut Oil",
    ...
    usage:
      "Take 1 to 2 tablespoons daily or use in salad dressings and cooking. for skin and hair, dilute with a carrier oil and apply topically as needed.",
    specifications: {
      volume: "250 ml",
      origin: "Indonesia",
  ...
  },
  {
    ...
    benefits: [
      ...
      "Cancer Risk Reduction",
      "Helps reduce symptoms of atopic dermatitis.",
      "Acts as a powerful antioxidant with “anti-aging” properties.",
      " Reduces inflammation and promotes skin cell regeneration.",
      "Diabetes Prevention",
      "Gut Health",
      "Has laxative properties that can improve gut health and relieve constipation.",
    ],
    ingredients: ["100% Pure Flax Seeds", "Cold-pressed"],
    usage:
      "Can be consumed 1 tablespoon for health benefits or applied topically for skincare. Avoid using it for frying or cooking above 110°C (boiling point).",
    specifications: {
      volume: "250 ml",
      origin: "Indonesia",
  ...
  },
  {
    ...
    usage:
      "Take 1 to 2 tablespoons daily or use in salad dressings, marinades, and cooking. For skin and hair, dilute with a carrier oil and apply topically as needed. Can also be baked at 180°C for 10-15 minutes to enhance its nutty flavor. Avoid using it for frying or cooking above 180°C to preserve its nutritional properties.",
    specifications: {
      volume: "250 ml",
      origin: "Indonesia",
      certification: "BPOM: 012219000100029",
  ...
  },
  {
    ...
    benefits: [
      ...
      "Stabilizes the function of the endocrine system.",
      "Neutralize toxins and free radicals.",
      "Prevent complications of rheumatism and arthritis.",
      "Has an anti-inflammatory effect.",
      "Helps maintain the health of the female reproductive system.",
      "Prevents the development of prostatitis,prostate adenoma in men.",
    ],
  ...
  },
  {
    ...
    benefits: [
      ...
      "Liver Support & Detox – Helps cleanse and protect liver function.",
      "Rich in Antioxidants – Fights free radicals and supports immune health.",
      "Heart & Cholesterol Support – Contains healthy fats for cardiovascular wellness.",
      "Skin & Hair Care – Hydrates and nourishes for a radiant glow.",
    ],
    ingredients: [
  ...
  },
  {
    ...
    benefits: [
      ...
      "Skin Health – Hydrates, heals, and protects against free radical damage.",
      "Anti-inflammatory Properties – Reduces inflammation and supports immune function.",
      "Energy Boost – Helps increase energy levels and maintains satiety.",
      "Cooking Use – Ideal for frying, baking, dressings, and marinades.",
      "Skincare Use – Acts as a non-comedogenic moisturizer and makeup remover.",
      "Hair Care Use – Improves shine, strength, and prevents breakage.",
    ],
  ...
  },
  {
    ...
    benefits: [
      "Energy & Vitality – Acts as an ancient superfood to sustain endurance and fight fatigue.",
      "Skin Health – Nourishes with antioxidants to improve hydration, elasticity, and glow.",
      "Heart Health – Supplies plant-based Omega-3 (ALA) to support healthy cholesterol and circulation.",
      "Brain & Mood – Enhances cognitive performance, memory focus, and emotional stability.",
      "Anti-Inflammatory Support – Reduces swelling and stiffness to assist joint and muscle recovery.",
    ],
